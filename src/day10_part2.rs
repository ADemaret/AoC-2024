...
mod tests {
    ...
    fn test_total() {
        ...
        assert_eq!(
            get_answer(include_str!("../assets/day10_input_demo6.txt")),
            Some(227)
        );
        assert_eq!(
            get_answer(include_str!("../assets/day10_input_demo7.txt")),
            Some(81)
        );
        assert_eq!(get_answer(include_str!("../assets/day10_input.txt")), Some(1786));
    }
}
